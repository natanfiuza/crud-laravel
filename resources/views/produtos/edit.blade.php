                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <form action={{ route('empresas.edit', $empresas->id) }} method="POST"
                                enctype="multipart/form-data" class="form-fluid p-4 rounded shadow bg-white">
                                @csrf
                                @method('PUT')
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="inputNomeResponsável">
                                            <x-bi-person-fill class="mr-2" />Nome do Responsável
                                        </label>
                                        <input type="text"
                                            class="form-control  {{ $errors->has('responsavel') ? 'is-invalid' : '' }}"
                                            id="inputNomeResponsável" placeholder="Nome do Responsável"
                                            name="responsavel" value="{{$empresas->responsavel}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text"
                                            class="form-control layout {{ $errors->has('layout') ? 'is-invalid' : '' }}"
                                            id="inputLayout" placeholder="layout" name="layout"
                                            value="{{$empresas->layout}}">
                                    </div>
                                </div>

                                <div class="form-row">
                                    <button type="submit" class="btn btn-secondary mt-2">Salvar</button>
                                    <a class="ml-3" href="{{ route('empresas.list')}}"><button type="button"
