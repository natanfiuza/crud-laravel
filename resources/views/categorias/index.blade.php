...
@section('content_header')
    <div class="d-flex row justify-content-between">
        <h1 class="m-0 text-dark mb-4">Cadastrar Categoria</h1>

        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('categorias.list') }}">Cadastro</a></li>
...
@section('content')
    <div class="">
        ...
        <form action={{ route('categorias.store') }} method="POST" class="form-fluid p-4 rounded shadow"
